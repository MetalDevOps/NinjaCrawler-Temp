...
## [0.22.0](https://github.com/MetalDevOps/NinjaCrawler/compare/v0.21.0...v0.22.0) (2026-07-16)
...
* **companion:** capture single videos by URL ([6f481ad](https://github.com/MetalDevOps/NinjaCrawler/commit/6f481addd540911d547202bc123cda007843ba6c))
* **companion:** capture TikTok stories into the profile's Stories folder ([2abb56e](https://github.com/MetalDevOps/NinjaCrawler/commit/2abb56e61f89dc8614efd4bd3af828f9b241c9bd))
* **companion:** download selected Instagram stories ([9e33a29](https://github.com/MetalDevOps/NinjaCrawler/commit/9e33a298017f67fb666cc880b290a2963f34f3e1))
...
* **companion:** import browser account sessions ([5ba11cf](https://github.com/MetalDevOps/NinjaCrawler/commit/5ba11cf82366432f27706a974ec1f0e4b0a7f595))
* **companion:** import browser account sessions ([e098415](https://github.com/MetalDevOps/NinjaCrawler/commit/e0984153f1e0bed55f6528751fa5b25dd61f8c0b))
* **connectors:** add managed connector bootstrap ([b5e60ba](https://github.com/MetalDevOps/NinjaCrawler/commit/b5e60ba3a016fdc1456328e63ed9fa53c78a2c0b))
...
* **core:** add the Tauri desktop runtime ([57b7c14](https://github.com/MetalDevOps/NinjaCrawler/commit/57b7c144f105ea52aebf566830559c5df62a6a68))
* **debugger:** Add realtime connector diagnostics ([a265b81](https://github.com/MetalDevOps/NinjaCrawler/commit/a265b81f004d583c6188e6c07cff12566f8c01d9))
* **debugger:** Add realtime connector diagnostics ([8edc610](https://github.com/MetalDevOps/NinjaCrawler/commit/8edc610e0b66ff97f061ed97ddc40fb0f5a6d148))
...
* **instagram:** support targeted story downloads ([54a8199](https://github.com/MetalDevOps/NinjaCrawler/commit/54a819990044256012225601f8ceb6d033c4b503))
* **profile-view:** add view-mode toggle and thumbnail density control ([323d65a](https://github.com/MetalDevOps/NinjaCrawler/commit/323d65a21cf3fcfd862bd1106d293e9e92653943))
* **profile-view:** delete media (single + multi-select) with re-download tombstone ([e2c19db](https://github.com/MetalDevOps/NinjaCrawler/commit/e2c19db1ce0b5b829ac2bc68ff3dfabcbeebebaa))
* **profile-view:** delete media (single + multi-select) with re-download tombstone ([8834c73](https://github.com/MetalDevOps/NinjaCrawler/commit/8834c73da7b1bef2419422f297ac092311453a13))
* **profile-view:** group highlights by album and fix their downloads ([1773c6e](https://github.com/MetalDevOps/NinjaCrawler/commit/1773c6e6e86f57a7c4829f25df7da3f4505db1b9))
* **profile-view:** group Instagram carousels by shortcode ([3393ec4](https://github.com/MetalDevOps/NinjaCrawler/commit/3393ec408eac0feaa99f0966924b2591bb993b06))
* **profile-view:** group Instagram carousels by shortcode ([28083b5](https://github.com/MetalDevOps/NinjaCrawler/commit/28083b5f4e374ae855b6a7d3e2e4a825f61cbda7))
* **profile-view:** hide the Online link for stories ([1805b08](https://github.com/MetalDevOps/NinjaCrawler/commit/1805b08ddc8b00869dc849a3e1f7c70b05ec13f9))
* **profile-view:** hide the Online link for stories ([f23763e](https://github.com/MetalDevOps/NinjaCrawler/commit/f23763e2d314be31a985318e5511c78cc16154e8))
* **profile-view:** highlights grouped by album + fix highlight downloads (v0.4.0) ([65e53b1](https://github.com/MetalDevOps/NinjaCrawler/commit/65e53b19735727caef27a757e620e3e2ae9ad744))
...
* **profile-view:** media deletion UX rework, pinned header, release v0.3.0 ([defb9f0](https://github.com/MetalDevOps/NinjaCrawler/commit/defb9f08801f52ef06634b3748699b8703c9debd))
* **profile-view:** rebuild Instagram/Twitter post links and split feed vs reels ([2304c16](https://github.com/MetalDevOps/NinjaCrawler/commit/2304c16d37e9e9a31aae1235931e1162fdcc8c8e))
* **profile-view:** rebuild Instagram/Twitter post links and split feed vs reels ([b16db90](https://github.com/MetalDevOps/NinjaCrawler/commit/b16db90fa801a281c86c76faa142c9527a8298e6))
* **profile-view:** rework media deletion UX and pin the header ([140d582](https://github.com/MetalDevOps/NinjaCrawler/commit/140d582c5011d26975e4e4dc7cddd63742b9c640))
* **profile-view:** view-mode toggle and thumbnail density control ([d694182](https://github.com/MetalDevOps/NinjaCrawler/commit/d69418229fdbd11c3245e1a56d659ce1483fbdf6))
...
* **release:** Publish Companion archive ([5d75abe](https://github.com/MetalDevOps/NinjaCrawler/commit/5d75abea54f468eb9bdb126b976c33400f32cd7e))
...
* Single Videos (queue, gallery, add-profile) + TikTok story capture ([b17edca](https://github.com/MetalDevOps/NinjaCrawler/commit/b17edca28dcc8796fe80f4a0701a9451b91eaefa))
* **single-videos:** add the Single Videos window (add-by-URL + filters) ([cd4c50b](https://github.com/MetalDevOps/NinjaCrawler/commit/cd4c50ba7a12ce48d7909caf1386dfbe99bdb10a))
* **single-videos:** data model + provider-agnostic yt-dlp downloader ([4500702](https://github.com/MetalDevOps/NinjaCrawler/commit/4500702544f765b32c35d737129e8da3d633ca16))
* **single-videos:** gallery parity, live refresh and add-profile menu ([e582f8f](https://github.com/MetalDevOps/NinjaCrawler/commit/e582f8f30db9ebed513315e1dc295325fe020aa0))
* **single-videos:** queue downloads via a dedicated runtime ([35a9532](https://github.com/MetalDevOps/NinjaCrawler/commit/35a9532e91d605600b059c1ff5f87d7bf7b11062))
...
* **source-editor:** allow manually editing a locked handle ([d4927c9](https://github.com/MetalDevOps/NinjaCrawler/commit/d4927c91e22ea8ad871ce385c7abd187a97954f2))
* **source-editor:** manual handle edit + history record (v0.5.1) ([7fac4e8](https://github.com/MetalDevOps/NinjaCrawler/commit/7fac4e8bddebb6d96e08bf12d8348d7e031bf205))
* **source-editor:** record manual handle changes in profile history ([b072187](https://github.com/MetalDevOps/NinjaCrawler/commit/b0721870193f492fdb9fa5382321ba29592928c2))
...
* **twitter:** backfill post key on existing media + stop bogus filename links ([2761a68](https://github.com/MetalDevOps/NinjaCrawler/commit/2761a6849b26d8c84d395fc1be61f70da81a3b1d))
* **twitter:** backfill post key on existing media + stop bogus filename links ([6fde66f](https://github.com/MetalDevOps/NinjaCrawler/commit/6fde66f9ca6339fc98b8f889d681e3eb6b0c49b2))
* **ui:** add the desktop workspace interface ([ca917a4](https://github.com/MetalDevOps/NinjaCrawler/commit/ca917a4fcbe093fb494c446dbfff77ac08913224))
...
* **windows:** migrate utility windows to custom visual shell ([#2](https://github.com/MetalDevOps/NinjaCrawler/issues/2)) ([6dd8c63](https://github.com/MetalDevOps/NinjaCrawler/commit/6dd8c63c6f82bb26de7718362b12685b1f67c6b0))
...
* **build:** resolve connector release download URLs ([4324f4c](https://github.com/MetalDevOps/NinjaCrawler/commit/4324f4c5dafe34f495b3a71148b4b0520c7a4fb3))
...
* **profile-view:** rebuild Twitter post links from the legacy SCrawler XML ([05029a2](https://github.com/MetalDevOps/NinjaCrawler/commit/05029a2e124ae221eaf1e0c0211785297176aa8a))
* **profiles:** recover renamed identities across providers ([8d8c269](https://github.com/MetalDevOps/NinjaCrawler/commit/8d8c269576963ebd5fe39712b58cbfbd276d8a5e))
* **profiles:** Recover renamed provider identities ([d90c756](https://github.com/MetalDevOps/NinjaCrawler/commit/d90c756136d1f9f3fa4d1fe1b107c696066a29fe))
* **profiles:** Stabilize saved profile selection ([4f52d80](https://github.com/MetalDevOps/NinjaCrawler/commit/4f52d803f8594b99ca29a8cadd1b6ae69310394d))
...
* **release:** regenerate sibling release pull requests ([#139](https://github.com/MetalDevOps/NinjaCrawler/issues/139)) ([6ab297d](https://github.com/MetalDevOps/NinjaCrawler/commit/6ab297db938e7ff13ff098a06e6aa931fd9ccffa))
...
* **single-videos:** window ACL + toolbar entry; queue TikTok story downloads ([5040066](https://github.com/MetalDevOps/NinjaCrawler/commit/50400666eb5c73e9d0078c584f96e4daf45f213d))
...
* **profile-view:** virtualize large profiles with progressive rendering ([9627874](https://github.com/MetalDevOps/NinjaCrawler/commit/9627874db018dc96a8bdc53317696906cddf622f))
* **profile-view:** virtualize large profiles with progressive rendering ([3d89906](https://github.com/MetalDevOps/NinjaCrawler/commit/3d899060e03ccce50682ee7c0e5fbced4d05f9c6))
