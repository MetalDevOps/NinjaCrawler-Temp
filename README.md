...
3. Install with the setup executable, or download the [portable zip](https://github.com/MetalDevOps/NinjaCrawler/releases/download/v0.17.1/NinjaCrawler-0.17.1-windows-x64-portable.zip) if you prefer a folder-based build.
